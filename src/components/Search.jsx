  ...
  return (
    <div className='m-3'>
      <div class="input-group mt-1">
        <input type="text" onChange={(e)=>{searchContact(e.target.value)}} className="form-control rounded-start-pill border-1 border-success" aria-label="Text input with dropdown button" />
